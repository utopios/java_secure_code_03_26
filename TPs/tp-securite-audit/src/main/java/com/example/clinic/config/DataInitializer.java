...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        Doctor dr1 = new Doctor("dr.martin", hashPassword("martin2024"), "Dr. Sophie Martin", "Cardiologie", "DOCTOR");
        Doctor dr2 = new Doctor("dr.dupont", hashPassword("dupont2024"), "Dr. Pierre Dupont", "Neurologie", "DOCTOR");
        Doctor admin = new Doctor("admin", hashPassword("admin"), "Administrateur", "Administration", "ADMIN");
